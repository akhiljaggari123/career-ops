...
Classify the offer into one of the 9 archetypes (see `_shared.md`). Prioritize standard Software Engineering archetypes (Full Stack, Backend, Frontend) if the role is a development-focused role. This determines:
